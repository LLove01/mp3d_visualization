...
def process_image(image_path):
    ...
    def update(frame):
        ...
        ax.view_init(elev=10, azim=frame)  # Adjust the rotation here
    ...
    anim = FuncAnimation(fig, update, frames=np.arange(-90, 0, 1), interval=20)
    anim.save('pose_rotation.gif', writer=PillowWriter(fps=20))
